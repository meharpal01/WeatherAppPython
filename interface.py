...
def getWeather():
    try:
        ...
        #weather api
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=9388c7a524f2d393be1913ad67d6bbd4"
        ...
        messagebox.showerror("weather Sense","Invalid Entry!!")
